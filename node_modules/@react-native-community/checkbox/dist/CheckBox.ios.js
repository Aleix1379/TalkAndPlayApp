...
var CheckBox = /** @class */ (function (_super) {
    ...
    function CheckBox() {
        ...
        _this._onChange = function (event) {
            var _a = _this.props, onValueChange = _a.onValueChange, onChange = _a.onChange;
    ...
    CheckBox.prototype.render = function () {
        var _a = this.props, accessible = _a.accessible, style = _a.style, 
        // Do not use onValueChange directly from props
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        onValueChange = _a.onValueChange, disabled = _a.disabled, value = _a.value, testID = _a.testID, props = __rest(_a, ["accessible", "style", "onValueChange", "disabled", "value", "testID"]);
        return (react_1.default.createElement(react_native_1.View, { testID: testID, pointerEvents: disabled ? 'none' : 'auto', accessible: accessible != null ? accessible : true, accessibilityRole: "checkbox", accessibilityState: {
                checked: value || false,
            ...
            react_1.default.createElement(IOSCheckBoxNativeComponent_1.default, __assign({}, props, { 
                ...
                style: [styles.rctCheckBox, style], ref: this._setNativeRef, onValueChange: this._onChange }))));
    };
    return CheckBox;
